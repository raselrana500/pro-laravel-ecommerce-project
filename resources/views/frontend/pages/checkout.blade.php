                    ...
                    <div class="cart_items">
                        <ul class="cart_list">
                            ...
                            <li class="cart_item clearfix">
                                <div class="cart_item_image text-center"><br><img src="{{ asset($row->options->image) }}" alt=""></div>
                                <div class="cart_item_info d-flex flex-md-row flex-column justify-content-between">
                                    ...
                                    <div class="cart_item_quantity cart_info_col">
                                        ...
                                        <form action="{{ route('update.cartqty') }}" method="post">
                                            ...
                                            <button type="submit" class="btn btn-primary btn-sm"><i class="fas fa-check-square"></i></button>
                                        </form>
                                    </div>
                            ...
                            <div class="order_total_content" style="padding:15px;">
                                ...
                                <form action="{{ route('apply.coupon') }}" method="post">
                                    ...
                                    <div class="form-group col-lg-4">
                                        <input type="text" name="coupon" style="width: 200px;" class="form-control" required="" placeholder="Enter Your coupne">
