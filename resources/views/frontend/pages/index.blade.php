...
->where('products.status',1)->where('products.hot_deal',1)->orderBy('products.id','desc')
->limit(3)
->get();
@endphp
							...
							<div class="owl-item deals_item">
								...
								<div class="deals_content">
									<div class="deals_info_line d-flex flex-row justify-content-start">
										...
										@else
										<div class="deals_item_price_a ml-auto"><del>${{ $row->selling_price}}</del></div>
										@endif
									</div>
									<div class="deals_info_line d-flex flex-row justify-content-start">
			...
			<div class="col-lg-9">
				<div class="popular_categories_slider_container">
					<div class="owl-carousel owl-theme popular_categories_slider">
						@php
						$popularCat = DB::table('categories')->get();
						@endphp
						@foreach($popularCat as $row)
...
->join('brands','products.brand_id','brands.id')
->select('products.*','brands.name','categories.category_name')
->where('products.mid_slider',1)->orderBy('products.id','desc')
->limit(3)
->get();
						...
						<div class="row fill_height">
							<div class="col-lg-4 col-md-6 fill_height">
								<div class="banner_2_content">
									...
									<div class="button banner_2_button"><a href="#" id="{{ $row->id }}"data-toggle="modal" data-target="#cartmodal" onclick="productview(this.id)" data-id="{{ $row->id }}">Explore</a></div>
								</div>

							</div>
							<div class="col-lg-8 col-md-6 fill_height">
								<div class="banner_2_image_container">
									<div class="banner_2_image"><img src="{{ asset($row->image_one) }}" style="width:400px;" alt=""></div>
								</div>
							</div>
						</div>
					</div>
...
@include('frontend.pages.womens');

<!-- category watch -->

@include('frontend.pages.watch');
<!-- Best Sellers -->
			...
			<div class="col-lg-4 advert_col">
				...
				<div class="advert d-flex flex-row align-items-center justify-content-start">
					<div class="advert_content">
						...
						<div class="advert_text">Delete</div>
					</div>
					<div class="ml-auto">
		...
		<div class="row">
			...
			<div class="col-lg-3">
				<div class="trends_container">
					<h2 class="trends_title">Buy one Get one free</h2>
					<div class="trends_text">
						<p>If you buy one product you will get one free.</p>
					</div>
						...
						<div class="owl-item">
							<div class="trends_item is_new">
								...
								<div class="trends_content">
									<div class="trends_category"><a href="#">{{ $row->name }}</a></div>
		...
		<div class="row ">
			<div class="col-sm-12">
				<div class="newsletter_container d-flex flex-lg-row flex-column align-items-lg-center align-items-center justify-content-lg-start justify-content-center">
					...
					<div class="newsletter_content clearfix text-center">
      ...
      <div class="modal-body">
        <div class="row">
			...
			<div class="col-md-4">
				...
				<button id="{{ $row->id }}"data-toggle="modal" data-target="#cartmodal" onclick="productview(this.id)"class="btn btn-primary" data-id="{{ $row->id }}">Add to Cart</button>
