    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-5" style="border:1px solid grey;padding:20px;border-radius:25px;">
                <div class="contact_form_container">
                    <div class="contact_form_title text-center">Payment by Strip</div>
...
<script type="text/javascript">
    ...
    var stripe = Stripe('pk_test_51JiAfjIXmdYFNxCRKxYaadCVf21MFagUC0xgJFJPgFVGROobJPDKVDr31528jyWkvUvJXQjZxLmCsLeowwoRydqL00smt0cvEW');
