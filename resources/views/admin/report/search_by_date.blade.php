...
<div class="sl-mainpanel">
      ...
      <div class="sl-pagebody">
        ...
        <div class="card pd-20 pd-sm-40">
          <h4 class="card-body-title text-center"><span class="badge badge-success"style="font-size: 20px;">{{ count($order) }}
                </span> Order Successfully Delivered in <span class="badge badge-info"style="font-size: 20px;">{{ $formatedeDate }}</span></h4>
        ...
        @endif
          <div class="table-wrapper">
            ...
            <h2 class="card-body-title text-center">Total <span class="badge badge-success" style="font-size: 20px;">{{ $total }} $ 
            </span> Delivered In <span class="badge badge-info"style="font-size: 20px;"> {{ $formatedeDate }} </span></h2>
          </div><!-- table-wrapper -->
        </div><!-- card -->
    </div><!-- sl-mainpanel -->
    <!-- ########## END: MAIN PANEL ########## -->
