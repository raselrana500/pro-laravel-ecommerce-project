      ...
      <div class="sl-pagebody">
        ...
        <div class="card pd-20 pd-sm-40">
          <h4 class="card-body-title text-center"><span class="badge badge-success"style="font-size: 20px;">{{ count($order) }}
                </span> Order Successfully Delivered in <span class="badge badge-success"style="font-size: 20px;">{{ $year }}</span></h4>
        ...
        @endif
          <div class="table-wrapper">
            ...
            </span> Delivered In <span class="badge badge-danger"style="font-size: 20px;"> {{ $year }} </span></h2>
          </div><!-- table-wrapper -->
        </div><!-- card -->
    </div><!-- sl-mainpanel -->
    <!-- ########## END: MAIN PANEL ########## -->
