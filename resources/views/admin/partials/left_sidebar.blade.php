<div class="sl-sideleft-menu">
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="{{ route('add.products') }}" class="nav-link">Add Product</a></li>
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="{{ route('blog.category.list') }}" class="nav-link">Blog Category</a></li>
