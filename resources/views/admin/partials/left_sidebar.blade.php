<div class="sl-sideleft-menu">
        ...
        <ul class="sl-menu-sub nav flex-column">
          ...
          <li class="nav-item"><a href="{{ route('admin.payment.accept') }}" class="nav-link">Payment Accepted </a></li>
          <li class="nav-item"><a href="{{ route('admin.process.delivery') }}" class="nav-link">Processing </a></li>
        ...
        <ul class="sl-menu-sub nav flex-column">
          ...
          <li class="nav-item"><a href="{{ route('this.month') }}" class="nav-link">This Month Delivered</a></li>
