          ...
          <div class="table-wrapper">
            <table id="datatable1" class="table display responsive nowrap">
              ...
              <tbody>
                  ...
                  <td>{{ $key+1 }}</td>
                  <td>{{ $row->name }}</td>
                  <td><img src="{{ URL::to($row->logo) }}" style="width:50px;" alt=""></td>
                  <td>
    ...
    <div class="modal-content tx-size-sm">
        ...
        <div class="modal-body pd-20">       
            ...
            <div class="form-group">
                ...
                <input type="file" name="logo" id="image" placeholder="Brand Logo" class="form-control"  >
            </div>
...
<div id="modaledit{{ $row->id }}" class="modal fade">
    ...
    <div class="modal-content tx-size-sm">
        ...
        <form method="post" action="{{ route('update.brand',$row->id) }}" enctype="multipart/form-data"> 
            @csrf
            <div class="modal-body pd-20">       
                <div class="form-group">
                    <label for="exampleInputEmail1">Brand Name</label>
                    <input type="text" class="form-control" name="name" value="{{ $row->name }}" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Category">
                
            </div>

            <div class="form-group">
                <label><strong>Old Image</strong></label><br>
                <img src="{{ URL::to($row->logo) }}" style="width:100px;" alt=""><br><br>
                <input type="hidden" name="oldImage" value="{{ $row->logo}}">
                <label><strong>Select new Image</strong></label><br>
                <input type="file" name="logo" id="image" placeholder="Brand Logo" class="form-control"  >
            </div>
